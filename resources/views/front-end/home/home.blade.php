...
<header>
  <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
      ...
      <div class="carousel-item active" style="background-image: url({{ asset('/') }}assets/image/slider.jpg)">
      ...
      <div class="carousel-item" style="background-image: url({{ asset('/') }}assets/image/slider.jpg)">
        <div class="carousel-caption d-none d-md-block">
          <h3>Second Slide</h3>
